...
assert.match(html, /id="fieldSummaryCard"/);
assert.match(html, /function renderFieldSummaryCard\(\)/);
assert.match(html, /function openFieldSummaryAction\(code\)/);
...
assert.match(sw, /"\.\/field-summary\.js"/);
