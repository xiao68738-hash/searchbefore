...
assert.match(html, /const APP_VERSION="0\.3\.9\.7"/);
assert.match(sw, /const CACHE_VERSION = "v0\.3\.9\.7-agent-usage-cache-2026-08-14"/);
...
assert.match(sw, /v0\.3\.9\.7-agent-usage-cache/);
