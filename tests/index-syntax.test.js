...
assert.match(html, /const APP_VERSION="0\.3\.9\.8"/);
assert.match(sw, /const CACHE_VERSION = "v0\.3\.9\.8-reviewed-no-detect-2026-08-29"/);
...
assert.match(sw, /v0\.3\.9\.8-reviewed-no-detect/);
