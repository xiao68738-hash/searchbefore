...
一、本人開發免費之農民用藥查詢工具「噴前查 SearchBefore」
    （https://searchbefore.tw），資料來源為 貴署農藥資料開放平臺
...
一、本人開發免費之農民用藥查詢工具「噴前查 SearchBefore」
    （https://searchbefore.tw），將 貴署「農藥殘留容許量標準」
    （現行版本：民國115年4月21日修正）與農業部農藥登記資料勾稽，
    以提醒農民注意殘留容許量。

二、勾稽過程中，下列情形無法自行判斷，懇請釋示：
...
三、本工具為非營利之農民輔助工具，於 貴署釋示前，一律不顯示上述
    藥劑之殘留容許量資訊，並標示「本工具尚未完成此作物的殘留容許量
    對照，用藥前請另行確認」，以免誤導農民。
