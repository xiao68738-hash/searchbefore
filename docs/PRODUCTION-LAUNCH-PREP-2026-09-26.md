...
| 順序 | 工作 | 可完成條件 | 目前狀態 |
|---|---|---|---|
| 1 | Play 原地升級 | 保留首次安裝時間、帳號及資料；匯出完整 JSON 前後逐欄比對，再驗證手動同步／重啟 | 9/26手機Play實際顯示離線，仍v8；備份已匯出，不以側載或卸載代替 |
...
| 4 | 最終正式候選 | 確認可用版號，移除內部／預覽標示；重建、簽章、Manifest、測試、Play 驗收 | v10／1.1.4本機簽署與檢核完成，發布鎖保留；Play驗收仍待 |
